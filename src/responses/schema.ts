...
const inputAudioBlockSchema = z.object({ type: z.literal("input_audio"), audio_url: z.string() });
...
// Current codex-rs FunctionCallOutputContentItem also includes input_audio.
